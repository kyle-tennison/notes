...
^hydrostatic-gradiet
> Assuming $g$ acts in the $z$ axis.

From this, we can see that pressure does not change in the x and y axes, when gravity acts in the z axis. To solve for pressure, we can isolate the equation:
