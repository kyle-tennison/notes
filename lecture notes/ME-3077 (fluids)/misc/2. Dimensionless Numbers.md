...
where $\rho$ is density, $V$ is velocity, $L$ is the characteristic length, and $\mu$ is the dynamic viscosity. 
...
The derivation of this from [Buckingham's Pi Theorem](7.%20Buckingham%20Pi%20Theorem.md) is shown [here](7.%20Buckingham%20Pi%20Theorem.md#^reyonolds-number).
