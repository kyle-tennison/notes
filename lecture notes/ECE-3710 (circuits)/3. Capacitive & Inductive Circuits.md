...
2. a circuit that's described a second-order differential equation
...
The **damping ratio** is defined as $\xi = \frac{\alpha }{w_0}$ . This can quickly tell you:
